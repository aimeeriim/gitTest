...
<div ><a href="#" className="kitchen">Кухни</a></div>
<div ><a href="#" className="hallways">Прихожие</a></div>
<div ><a href="#" className="cabinets">Шкафы</a></div>
<div ><a href="#" className="bedrooms">Спальни</a></div>
<div ><a href="#" className="office">Офисная мебель</a></div>
<div ><a href="#" className="mattresses">Матрасы</a></div>
<div ><a href="#"className="room">Гостинные</a></div>
<div ><a href="#" className="child">Детская</a></div>
<div ><a href="#" className="furniture">Мягкая мебель</a></div>
<div ><a href="#" className="action">Акция</a></div>
<div ><a href="#" className="new">Новинки</a></div>
</div>
        <div className='logo'>LM</div> 
     
             <div className='footer_right'>
            
              <div className='adress'>г. Анапа, Анапское шоссе,<br></br>
                                        30 Ж/К Черное море
                </div>
                <div className='telephone'>8 (964) 89 99 119</div>
                
                <div className='instagram'>INSTAGRAM</div>
                <div className='loft'>mebel_loft_anapa@mail.ru</div>
                ...
                <svg className="icon2"width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className='icon3' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
